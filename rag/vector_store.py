...
class VectorStoreService:
    def __init__(self):
        self.vector_store = Chroma(                         # 向量存储
            collection_name=chroma_conf["collection_name"],
            embedding_function=embed_model,
            persist_directory=get_abs_path(chroma_conf["persist_directory"]),
        )

        self.spliter = RecursiveCharacterTextSplitter(       # 文本分片
    ...
    def load_document(self):                                # 加载文档
        ...
        allowed_files_path: list[str] = listdir_with_allowed_type(      # 允许的文件路径
